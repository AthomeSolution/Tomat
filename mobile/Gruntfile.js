// Generated on 2014-04-04 using generator-ionicjs 0.2.4
'use strict';
    ...
    grunt.initConfig({
        ...
        less: {
            compile: {
                ...
                files: {
                    '<%= yeoman.app %>/styles/main.css': ['<%= yeoman.app %>/assets/less/main.less']
                }
        ...
        copy: {
            dist: {
                files: [
                    ...
                    {expand: true, cwd: '<%= yeoman.app %>/bower_components/ionic/release/fonts/', dest: 'www/fonts/', src: '*'},
                    {expand: true, cwd: '<%= yeoman.app %>/bower_components/font-awesome/fonts/', dest: 'www/fonts/', src: '*'},
                    {expand: true, cwd: '<%= yeoman.app %>/bower_components/open-sans/fonts/', dest: 'www/fonts/', src: '**'},
                    {expand: true, cwd: '<%= yeoman.app %>/bower_components/Leaflet.awesome-markers/dist/images/', dest: 'www/styles/images/', src: '**'}
                ]
            },
            styles: {
                expand: true,
            ...
            fonts: {
                files: [
                    {expand: true, cwd: 'app/bower_components/ionic/release/fonts/', dest: '<%= yeoman.app %>/fonts/', src: '*'}
                ]
            },
            vendor: {
                expand: true,
